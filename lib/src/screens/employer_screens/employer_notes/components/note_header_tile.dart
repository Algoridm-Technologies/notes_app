            ...
            children: [
              value.isChecking
                  ...
                  : Expanded(
                      ...
                      onChanged: (v) {
                        print(v);
                        for (var i = 0; i < value.positions.length; i++) {
                          if (value.positions[i].text!.contains(v)) {
                            value.addToList(value.positions[i]);
                          }
                        }
                      },
